  ...
  useEffect(() => {
    ...
    const y = d3
      ...
      .domain([
        0,
        d3.max(
          Object.keys(filteredData).flatMap((location) =>
            Object.values(filteredData[location]).flatMap((type) => [
              +type.Verde,
              +type.Tinto,
            ])
          )
    ...
    const typeNames = [
      "Tinto Total",
      "Tinto Vinho licoroso com DOP",
      "Tinto Vinho com DOP",
      "Tinto Vinho com IGP",
      "Tinto Vinho com indicação de casta",
      "Tinto Vinho sem certificação",
      "Verde Total",
      "Verde Vinho licoroso com DOP",
      "Verde Vinho com DOP",
      "Verde Vinho com IGP",
      "Verde Vinho com indicação de casta",
    ...
    svg
      ...
      .style("opacity", (d) => (visibleTypes[d.type] ? 1 : 0));
